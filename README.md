...
 Using this line, you get Yeoman to automatically generate another API endpoint and new kind of collection for your database. Now we have *things* as well as *whatsits*! Feel free to open up the **/server/api/whatsit/whatsit.model.js** and define your whatsit however you like.
